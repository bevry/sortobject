...
``` typescript
import pkg from 'https://unpkg.com/sortobject@^4.9.0/edition-deno/index.ts'
```
...
``` html
<script type="module">
    import pkg from '//cdn.pika.dev/sortobject/^4.9.0'
</script>
```
...
``` html
<script type="module">
    import pkg from '//unpkg.com/sortobject@^4.9.0'
</script>
```
...
``` html
<script type="module">
    import pkg from '//dev.jspm.io/sortobject@4.9.0'
</script>
```
